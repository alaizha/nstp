...
<head>
    ...
    <title>Register Form in HTML and CSS | ITC-111</title>
...
<body>
    <div class="wrapper">
        <form action="">
            ...
            <div class="input-box">
                <input type="id" placeholder="09xxxxxxxxxx" required>
                <i class='bx bxs-phone' ></i>
            </div>
            <button type="submit" class="btn">Register</button>
            <div class="login-link">
                <p>Already have an account? <?php echo '<a href="/login">Login</a>'; ?></p>
            </div>
        </form>
    </div>
</body>
